...
- از راهنمای رسمی [DEPLOYMENT_RUNBOOK.md](../backup_and_recovery/DEPLOYMENT_RUNBOOK.md) که به عنوان سند زنده برای کارشناسان زیرساخت تدوین شده است استفاده نمایید.
