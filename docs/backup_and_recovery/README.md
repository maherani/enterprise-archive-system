# مستندات و راهنماهای عملیاتی پشتیبان‌گیری، پایداری داده‌ها و بازیابی سامانه
**سامانه بایگانی اسناد سازمانی بانک مسکن • نگارش v2.9.0**

این پوشه شامل کلیه راهنماهای فنی، اجرایی و عملیاتی استاندارد (SOP) مرتبط با چرخه حیات داده، پایداری، پشتیبان‌گیری و بازیابی اطلاعات در سناریوهای مختلف است:
...
| **مستند پایداری داده‌ها و تحلیل ریشه‌ای (Data Persistence & RCA)** | تحلیل ریشه‌ای پایداری داده‌ها، معماری پایگاه داده، ایزولاسیون دیسک و سناریوهای تداخل بوت | معماران نرم‌افزار و راهبران سیستم | [DATA_PERSISTENCE_AND_RELIABILITY.md](DATA_PERSISTENCE_AND_RELIABILITY.md) |
...
graph LR
    ...
    subgraph SOPs [راهنماهای عملیاتی این پوشه]
        ...
        DPR[DATA_PERSISTENCE_AND_RELIABILITY.md]
    end
