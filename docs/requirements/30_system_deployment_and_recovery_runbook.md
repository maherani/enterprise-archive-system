...
- **سند زنده اپراتوری (Living Operator Guide):** راهنمای گام‌به‌گام و جامع اپراتورها در فایل [`docs/DEPLOYMENT_RUNBOOK.md`](../DEPLOYMENT_RUNBOOK.md) ایجاد شده و به عنوان سند زنده سامانه ثبت گردید. بر اساس قانون حاکمیت مستندات، به‌ازای هر تغییر ساختاری، معماری، متغیرهای `.env` یا اسکریپت‌های استقرار، سند اپراتوری همگام با این نیازمندی به‌روزرسانی می‌شود.
