...
| **24** | **اشتراک فایل و پوشه با گروه‌ها توسط Admin، مدیریت فایل گروهی و حاکمیت ایزوله تگ‌های گروه** | [`24_admin_group_sharing_and_file_management.md`](24_admin_group_sharing_and_file_management.md) | مستقل / حاکمیتی امنیتی | 08, 15, 17, 18, 21, 23 | اشتراک پویا با گروه‌ها توسط ادمین، ارث‌بری دسترسی، تگ‌گذاری خودکار گروهی در آپلودها، ایزولاسیون کامل تگ‌ها و عدم دور زدن ادمین، مودال اشتراک و تست‌های جامع | عملیاتی و نهایی (v2.3.0) |
| **25** | **ثبت اجباری متادیتای سند قبل از بارگذاری در بایگانی (Fail-Closed Document Metadata)** | [`25_mandatory_document_metadata.md`](25_mandatory_document_metadata.md) | مستقل / متادیتا و کنترل دسترسی | 02, 08, 17, 18, 21, 23 | لایه متادیتای الزامی اسناد، جدول oc_archive_document_metadata، رد درخواست بارگذاری بدون متادیتا (422)، یکپارچگی با دراور سریع و جستجوی پورتال | عملیاتی و نهایی (v2.4.0) |
