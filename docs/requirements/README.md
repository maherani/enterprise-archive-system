...
| **10** | **شخصی‌سازی هویت بصری، ماسکینگ و فیلتر اپ‌استور** | [`10_branding_masking_and_app_menu_filter.md`](10_branding_masking_and_app_menu_filter.md) | مستقل | 09 | فیلتر منوهای برنامه‌ها، حذف اپ‌استور، یکپارچه‌سازی تم سازمانی برای کلیه کاربران، اسکریپت ماسک URL نوار آدرس (`url_mask.js`)، هاست مجازی دامنه `docs.maskan` | عملیاتی و نهایی |
