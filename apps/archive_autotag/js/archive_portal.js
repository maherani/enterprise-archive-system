...
(function () {
    ...
    function renderApp() {
        ...
        root.innerHTML = [
            ...
            '',
            '  <!-- Controls Bar (Stats + View Toggle: Always Sticky with Top Section) -->',
            ...
            '      <button id="ea-view-grid-btn" class="ea-view-btn ' + (state.viewMode === 'grid' ? 'active' : '') + '" title="نمایش کارتی اسناد">',
            ...
            '        <span>کارت</span>',
            '      </button>',
            '      <button id="ea-view-table-btn" class="ea-view-btn ' + (state.viewMode === 'table' ? 'active' : '') + '" title="نمایش فهرستی اسناد">',
